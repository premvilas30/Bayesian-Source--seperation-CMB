...
GSL_VAR const gsl_multimin_fdfminimizer_type *gsl_multimin_fdfminimizer_vector_bfgs3;

//extern const gsl_multimin_fdfminimizer_type vector_bfgs3_type;

//extern const gsl_multimin_fdfminimizer_type *gsl_multimin_fdfminimizer_vector_bfgs3; 
